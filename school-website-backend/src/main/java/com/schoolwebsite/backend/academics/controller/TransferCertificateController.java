...
public class TransferCertificateController {
    ...
    public ResponseEntity<ApiResponse<List<TransferCertificate>>> verifyAndDownloadTC(
        ...
        return ResponseEntity.ok(ApiResponse.ok(
                service.searchTCs(tenantId, studentName, classLevel, section, admissionNo, fatherName, aadharNo)));
    }
    ...
    public ResponseEntity<ApiResponse<List<TransferCertificate>>> getIssuedTCs(@PathVariable Long tenantId) {
        return ResponseEntity.ok(ApiResponse.ok(
                service.searchTCs(tenantId, null, null, null, null, null, null)));
    }

    @PostMapping("/admin/sites/{tenantId}/tc")
    public ResponseEntity<ApiResponse<TransferCertificate>> issueTC(
            @PathVariable Long tenantId,
