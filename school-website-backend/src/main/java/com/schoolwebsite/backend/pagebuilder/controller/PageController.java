...
public class PageController {
    ...
    public ResponseEntity<ApiResponse<PageResponse>> createPage(@PathVariable Long tenantId,
    ...
    public ResponseEntity<ApiResponse<PageResponse>> getPageBySlug(@PathVariable Long tenantId,
    ...
    public ResponseEntity<ApiResponse<PageResponse>> updateSections(@PathVariable Long pageId,
            @RequestBody List<PageSectionDTO> sections) {
        return ResponseEntity
                .ok(ApiResponse.ok("Page sections updated", pageService.updatePageSections(pageId, sections)));
    }
